...
import HeaderImg from "../../../Main_images/HP_clinic_img_dark.png";
// import HeaderImg2 from "../../../Main_images/HP_clinic_img_2.png";
// import HeaderImg3 from "../../../Main_images/HP_clinic_img_3.png"
            ...
            <Container>
                <Row className="header-row">
                    <Col md="6" className="headings">
                        <p className="headings__p1">At Dr. Naveen’s Dental Clinic!</p>
                        <p className="headings__p3">More Than Just Teeth, We Care for Your Smile.</p>
                    ...
                    {/* <Col md="12" className="header-row__img">
                        <LazyLoadImage 
